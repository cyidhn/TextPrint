    ...
    <v-container fluid>
      ...
      <v-dialog v-model="dialogGlobal" max-width="1200px" persistent scrollable>
        <v-card>
          <v-card-title>
            <span class="headline">
              <b>Associer ces éléments à la collection</b>
            </span>
          </v-card-title>
          <v-card-text>
          ...
          <v-card-actions>
            ...
            <v-btn color="blue darken-1" text @click="fermerGlobal"
              >Retour</v-btn
            >
            <v-btn color="blue darken-1" text @click="sheet = true"
              >Nouveau</v-btn
            >
        ...
        <v-sheet class="text-center" height="200px">
          ...
          <div class="mt-4" @click="sheet = false">
            <v-btn class="ms-2" color="primary" @click="nouveauTexte" text
              >Texte</v-btn
            >
            <v-btn class="ms-2" color="primary" @click="nouveauDossier" text
              >Dossier</v-btn
            >
...
export default {
  ...
  methods: {
    ...
    addElementToGlobal() {
      if (confirm("Voulez-vous ajouter cette sélection à votre collection ?")) {
        let formData = new FormData();
