...
def analyse_reinert(chemin, LEM=True, NB_ARBRES=4, NB_MOTS=10, NB_ITERATIONS=100, NB_INIT=1):
    ...
    newDoc1 = impressionDoc[1].split(".")
    lienFinal = newDoc1[0] + "_reinert_" + str(ts) + ".html"
    newDoc1 = impressionDoc[0] + "/" + newDoc1[0] + \
        "_reinert_" + str(ts) + ".html"
